<?php
/**
 * Internationalisation file for CustomData extension.
 *
 * @package MediaWiki
...
$messages['en'] = array(
	'customdata-desc' => 'Provides an easy to use interface for other extensions that need to transfer data retrieved from the parser to the skin',
);
 ...
 */
$messages['id'] = array(
	'customdata-desc' => 'Menyediakan antarmuka ramah pengguna untuk ekstensi lain yang perlu mentransfer data yang diperoleh dari parser ke kulit',
);
 ...
 */
$messages['mk'] = array(
	'customdata-desc' => 'Дава лесен посредник за други додатоци што треба да му префрлаат податоци на рувото преземени од расчленувачот',
);
 ...
 */
$messages['uk'] = array(
	'customdata-desc' => 'Забезпечує простий у використанні інтерфейс для інших розширень, яким необхідно перенести дані, отримані з парсера, в обкладинку',
);
